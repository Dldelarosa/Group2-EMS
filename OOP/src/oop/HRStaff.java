...
public class HRStaff extends JFrame implements ActionListener{
    ...
    setDefaultCloseOperation(f.EXIT_ON_CLOSE);
        ...
        HRStaff = new JLabel();
        HRStaff.setIcon(new ImageIcon(new ImageIcon("C:\\Users\\admin\\Documents\\NetBeansProjects\\OOP\\OOP\\src\\oop\\HRStaff.jpg").getImage().getScaledInstance(800, 500, Image.SCALE_SMOOTH)));
